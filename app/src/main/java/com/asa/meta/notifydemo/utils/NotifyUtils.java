...
public class NotifyUtils {
    ...
    //创建默认Foreground提醒
    public static NotifyUtils buildForegroundNotify(Context context) {
        NotifyUtils notifyUtils = new NotifyUtils(context, NotifyUtils.FOREGROUND_NOTIFY_ID);
        notifyUtils.notifyForeground(null, R.mipmap.ic_launcher, context.getString(R.string.app_name), "这是一个苦逼的服务");
        return notifyUtils;
    }
    ...
    public void notifyForeground(PendingIntent pendingIntent, int smallIcon, String title, String content) {
        setCompatBuilder(pendingIntent, smallIcon, title, content, false, false, false);
